...
//var trafficLightRed   = document.querySelector(".light stop-light")
//var trafficLightGrn   = document.querySelector(".light slow-light")
//var trafficLightYlw   = document.querySelector(".light go-light")
...
// Event handlers
// -----------------------------------------------------------------------
function stop(e) {  // this event handler will trigger settimeout() for yellow then red
// step1 - grab the current light status whether it is go, slow or stop 
// step2 - based on the current light status to trigger diff routine

  //myVar = setTimeout(function, 120);
...
//------------------------------------------------------------------------
function slow(e) {  // this event handler will trigger setinterval() to yellow
// step1 - grab the current light status whether it is go, slow or stop 
// step2 - based on the current light status to trigger diff routine
...
//------------------------------------------------------------------------
function go(e) {  // this event handler will trigger settimeout() for yellow then green or just green
// step1 - grab the current light status whether it is go, slow or stop 
// step2 - based on the current light status to trigger diff routine
  trafficLight.classList.remove("stop");
  trafficLight.classList.remove("slow");
